...
async function checkAmplifyConfig() {
    try {
        ...
        console.log('ℹ️ Amplify not configured, using direct API calls');
        return false;
    }
}
...
async function callAI(userContent, options = {}) {
    ...
    if (amplifyConfig && window.aws_amplify && window.aws_amplify.API) {
        try {
            console.log('🚀 Using Amplify API backend');
...
async function main() {
    ...
    if (amplifyConfigured) {
        console.log('🚀 Running with Amplify serverless backend');
    } else {
        console.log('🔗 Running with direct API calls');
        console.log('💡 To use Amplify backend: follow AWS_AMPLIFY_GUIDE.md');
    }
    ...
    console.log('🎵 SpotifAI - StreamSmart ready!');
    if (amplifyConfigured) {
        console.log('✅ AI features running on AWS Amplify serverless backend');
    } else {
